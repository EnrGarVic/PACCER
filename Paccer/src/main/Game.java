...
public class Game implements Runnable {
    ...
    private void initClasses() {
        ...
        player1 = new Jugador1(200, 200, (int) (28 * SCALE), (int) (21 * SCALE));
            ...
            public void actionPerformed(ActionEvent e) {
                if (!gameOver) {
                    ...
                    if (timeLeft <= 0) {
                        gameOver = true;
                        timeLeft = 0;
                        registerWinner(serverUser ); // Registrar el servidor como ganador si el tiempo se acaba
    ...
    // Método para registrar el ganador en la base de datos
    private void registerWinner(String winner) {
        GameResult.insertWinner(winner);
    }
    ...
    public void startServer() {
        serverUser = currentUser; // Asignar el nombre de usuario del servidor
        servidor = new Servidor(this);
        new Thread(() -> servidor.start()).start();
    }

    public void startClient() {
        clientUser = currentUser; // Asignar el nombre de usuario del cliente
